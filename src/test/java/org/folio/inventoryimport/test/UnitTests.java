...
public class UnitTests {
    ...
    public void canRepositionTransformationStepsWhenAddingStep() {
        ...
        assertThat(getRecordById(PATH_TSAS, TSA_1).extract().path("position"), is(1));
        assertThat(getRecordById(PATH_TSAS, TSA_5).extract().path("position"), is(2));
        assertThat(getRecordById(PATH_TSAS, TSA_2).extract().path("position"), is(3));
        assertThat(getRecordById(PATH_TSAS, TSA_3).extract().path("position"), is(4));
        assertThat(getRecordById(PATH_TSAS, TSA_4).extract().path("position"), is(5));
    }
    ...
    public void canRepositionTransformationStepsWhenDeletingStep() {
        ...
        deleteRecord(PATH_TSAS, TSA_3, 200);
        assertThat(getRecordById(PATH_TSAS, TSA_1).extract().path("position"), is(1));
        assertThat(getRecordById(PATH_TSAS, TSA_2).extract().path("position"), is(2));
        assertThat(getRecordById(PATH_TSAS, TSA_4).extract().path("position"), is(3));
        assertThat(getRecordById(PATH_TSAS, TSA_5).extract().path("position"), is(4));
        deleteRecord(PATH_TSAS, TSA_3, 404);
